...
bool HtsFileStreamer::trySeekingToNextPrimaryAlignment()
{
    ...
    {
        const bool isSupplementary = htsAlignmentPtr_->core.flag & htshelpers::kSupplementaryAlign;
        const bool isSecondary = htsAlignmentPtr_->core.flag & htshelpers::kSecondaryAlign;
