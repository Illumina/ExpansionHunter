...
public:
    RepeatAnalyzer(
        ...
        graphtools::NodeId repeatNodeId, GenotyperParameters genotyperParams)
        : VariantAnalyzer(std::move(variantId), expectedAlleleCount, graph, { repeatNodeId }, genotyperParams)
