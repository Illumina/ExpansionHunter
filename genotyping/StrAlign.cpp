...
StrAlign ConsistentAlignmentCalculator::clipFromLeft(int numMotifsInAllele, const GraphAlignment& alignment)
{
...
StrAlign
ConsistentAlignmentCalculator::clipFromRight(int numMotifsInAllele, const graphtools::GraphAlignment& alignment)
{
    int leftFlankScore = 0, strScore = 0, rightFlankScore = 0;
    int strIndelCount = 0;
...
StrAlign ConsistentAlignmentCalculator::removeStutter(int numMotifsInAllele, const GraphAlignment& alignment)
{
    int leftFlankScore = 0, strScore = 0, rightFlankScore = 0;
    int strIndelCount = 0;
    int motifIndex = 0;
...
StrAlign ConsistentAlignmentCalculator::findConsistentAlignment(int numMotifsInAllele, const GraphAlignment& alignment)
{
